    ...
    <div className="bg-[#1a3e3e]">
      <div className="container1 flex flex-col lg:flex-row items-start justify-between py-6 sm:py-8 lg:py-12 gap-6 sm:gap-8 lg:gap-12">
        <div className="w-full lg:w-1/3">
          ...
          <p className="font-normal text-xs sm:text-sm text-white mb-4 sm:mb-6 leading-relaxed">
          ...
          <p className="font-semibold text-base sm:text-lg underline text-white mb-4 sm:mb-6">
            info@domain.com{" "}
        ...
        <div className="w-full lg:w-1/3">
          ...
          <ul className="space-y-2 sm:space-y-3">
            <li className="font-normal text-xs sm:text-sm text-[#fdfdfd] hover:text-[#f2be22] transition-colors cursor-pointer">
              Прогулки в горы летом
            </li>
            <li className="font-normal text-xs sm:text-sm text-[#f2be22] underline">
        ...
        <div className="w-full lg:w-1/3">
          ...
          <ul className="space-y-2 sm:space-y-3">
            ...
            <li className="font-normal text-xs sm:text-sm text-[#fdfdfd] hover:text-[#f2be22] transition-colors cursor-pointer">
              Медицинская страховка, гарантии безопасности Если вы врач -
              загляните сюда
            </li>
          </ul>
        </div>
